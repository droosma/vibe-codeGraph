...
install_copilot_cli() {
    ...
    local dest="$REPO_ROOT/.github/skills/codegraph"
    mkdir -p "$dest"
    cp "$SKILLS_DIR/copilot-cli/.github/skills/codegraph/skill.md" "$dest/skill.md"
...
install_vscode() {
    ...
    local dest="$REPO_ROOT/.github/skills/codegraph"
    mkdir -p "$dest"
    cp "$SKILLS_DIR/vscode/.github/skills/codegraph/skill.md" "$dest/skill.md"
...
echo "     git add .github/skills/ .claude/ skills/ AGENTS.md"
