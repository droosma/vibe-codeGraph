...
CodeGraph ships APM primitives in the `.apm/` directory that APM distributes to agent clients automatically:

| Primitive | File | Purpose |
|-----------|------|---------|
| **Instruction** | `.apm/instructions/codegraph.instructions.md` | Teaches agents when and how to use CodeGraph; injected automatically for `*.cs` files |
